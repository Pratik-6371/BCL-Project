  ...
  implements IPluginAppCommonData
{
  ...
  public SkillLoader(TableDataHandler tbHandler, SummaryViewDetail svDetail, ArrayList ccDetail, int vType, int col, ICommonData data)
  {
  ...
  protected ColumnData getData()
  {
    ...
    stmt = new SQLStatement(3, "business.cms.SummaryViewSqlStringConstant.SKILL", sqlSubstitutionArrayList);
  ...
  {
    return "com.kronos.wfc.cms.business.SkillLoader";
  }
}
