  ...
  implements IPluginAppCommonData
{
  ...
  public TradeLoader(TableDataHandler tbHandler, SummaryViewDetail svDetail, ArrayList ccDetail, int vType, int col, ICommonData data)
  {
  ...
  protected ColumnData getData()
  {
    ...
    stmt = new SQLStatement(3, "business.cms.SummaryViewSqlStringConstant.TRADE", sqlSubstitutionArrayList);
  ...
  {
    return "com.kronos.wfc.cms.business.TradeLoader";
  }
}
