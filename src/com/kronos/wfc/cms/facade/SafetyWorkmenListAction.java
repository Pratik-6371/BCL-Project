...
public class SafetyWorkmenListAction extends WFPLookupDispatchActions
{
  public SafetyWorkmenListAction() {}
  ...
  public ActionForward doEdit(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
  {
    ...
    try {
      ...
      List<PrincipalEmployee> pes; return mapping.findForward("doCMSSafetyTraining");
    }
    catch (Exception e) {
    ...
    throws Exception
  {
    ...
    try { String empCode = (String)data.getValue("empcode");
