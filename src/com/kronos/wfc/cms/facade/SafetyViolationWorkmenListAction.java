  ...
  extends WFPLookupDispatchActions
{
    ...
    throws Exception
  {
    ...
    try
    {
      ...
      List<PrincipalEmployee> pes; return mapping.findForward("doCMSSafetyViolation");
    }
    catch (Exception e)
    {
